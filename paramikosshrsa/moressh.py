...
def main():
    ...
    for cred in credz:
        ...
        ## create output.txt
        #sshsession.exec_command("touch output.txt")

        ## transfer displayed connections to output.txt
        print("Connecting to... " + cred.get("un") + "@" + cred.get("ip"), file=output.txt)
        ...
        sshsession.exec_command("touch results.log")
        print(sessout, file=results.log)
