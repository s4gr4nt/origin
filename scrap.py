...
class FileManager:
    ...
    def read_data(self):
        try:
            ...
            print(f"Error unpickling data in file '{self.file_path}'.")
            return None

# Example usage:
# file_manager = FileManager("data.pkl")
...
class AddOrRemoveBucketlist(tk.Frame):
    def __init__(self, parent, controller):
        ...
        file_manager = FileManager("data.pkl")
        read_data = file_manager.read_data()
        save_data = file_manager.write_data(self)
        ...
        save_button = tk.Button(self, bg="#eddcd2", font=font3, text="Save", command=save_data)
